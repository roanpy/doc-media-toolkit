...
- Duplicate image imports verify the stored file before reuse. Closing AI review stops the flow; merge suggestions require explicit review and confirmation.
